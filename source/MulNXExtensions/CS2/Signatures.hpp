...
namespace MulNX {
    namespace CS2 {
        namespace Signatures {
            ...
            inline const static MulNX::Memory::Pattern Pos_Spot_GetpEntForCheck("48 89 44 24 ?? 48 8B D8 48 85 C0 0F 84 ?? ?? ?? ?? 48 8B C8 E8 ?? ?? ?? ?? 4C 8B F8 48 85 C0 0F 84");
            inline const static MulNX::Memory::Pattern Pos_Spot_WriteBombState("84 C0 74 ?? 4C 8B BD ?? ?? ?? ?? 48 8D 54 24 ?? 48 8B CB 41 80 8F ?? ?? ?? ?? 01");
        }
    }
}