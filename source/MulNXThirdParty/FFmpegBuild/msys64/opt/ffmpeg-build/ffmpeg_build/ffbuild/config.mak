...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/opt/ffmpeg-build/ffmpeg_install --enable-shared --disable-static --disable-doc --disable-programs --enable-avdevice --enable-indev=dshow --enable-avcodec --enable-avformat --enable-avutil --enable-swscale --enable-swresample --enable-avfilter --disable-everything --enable-decoder='h264,aac,hevc,mp3' --enable-encoder='aac,libopenh264' --enable-demuxer='mov,mp4,matroska' --enable-muxer='mp4,mov' --enable-parser='h264,aac,hevc' --enable-protocol='file,http' --enable-filter='scale,format,trim,overlay' --enable-libopenh264 --extra-ldflags='-static-libgcc -static-libstdc++ -Wl,-Bstatic -lstdc++ -lpthread -Wl,-Bdynamic'
...
INSTALL_NAME_DIR=
SRC_PATH=/opt/ffmpeg-build/ffmpeg_src
SRC_LINK=/opt/ffmpeg-build/ffmpeg_src
...
CFLAGS=   -std=c17 -U__STRICT_ANSI__ -fomit-frame-pointer  -IC:/Users/lenovo/Desktop/MulNXDev/MulNX_CS2/source/MulNXThirdParty/FFmpegBuild/msys2/msys64/mingw64/include/wels -g -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wstack-usage=122880 -Wimplicit-fallthrough=5 -Wmissing-prototypes -Wstrict-prototypes -Wunterminated-string-initialization -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=format-security -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
ASFLAGS=   -g
GLSLCFLAGS=
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -std=c++11 -m64 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include /opt/ffmpeg-build/ffmpeg_src/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -P -o $@
...
DOXYGEN=doxygen
MAKEINFO=makeinfo
LDFLAGS= -static-libgcc -static-libstdc++ -Wl,-Bstatic -lstdc++ -lpthread -Wl,-Bdynamic  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Wl,-rpath-link=:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
EXTRALIBS-avformat=-lm -latomic -lz -lsecur32 -lncrypt -lcrypt32 -lws2_32
EXTRALIBS-avcodec=-liconv -lm -latomic -lz -lopenh264 -lstdc++ -lpthread -lole32 -luser32
...
!CONFIG_AV1_NVDEC_CUARRAY_HWACCEL=yes
...
!CONFIG_H264_NVDEC_CUARRAY_HWACCEL=yes
...
!CONFIG_HEVC_NVDEC_CUARRAY_HWACCEL=yes
...
!CONFIG_MPEG1_NVDEC_CUARRAY_HWACCEL=yes
...
!CONFIG_MPEG2_NVDEC_CUARRAY_HWACCEL=yes
...
!CONFIG_MPEG4_NVDEC_CUARRAY_HWACCEL=yes
...
!CONFIG_VP9_NVDEC_CUARRAY_HWACCEL=yes
...
!CONFIG_WMV3_NVDEC_CUARRAY_HWACCEL=yes
