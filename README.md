...
| 领域 | 技术 |
| ------ | ------ |
| 平台 · Platform | x64 汇编 · x64 assembly / 现代 C++ · modern C++ / Windows 系统编程 · Windows system programming |
| 核心 · Core | 逆向工程 · reverse engineering / 钩子 · hooking / 运行时代码生成 · runtime code generation |
| 交互 · Interaction | 网络 · networking / 即时模式 GUI · immediate‑mode GUI / 音视频 · audio/video |
| 工程 · Engineering | **软件工程与架构 · software engineering and architecture** |
