...
macro(strip_whitespace_from_list _var)
  set(_tmp)
...
macro(find_component _component _pkgconfig _library _header)
  ...
  strip_whitespace_from_list("${_component}_LIBRARIES")
  strip_whitespace_from_list("PC_${_component}_LIBRARIES")
  strip_whitespace_from_list("${_component}_INCLUDE_DIRS")
  strip_whitespace_from_list("${_component}_DEFINITIONS")
  string(STRIP "${PC_${_component}_CFLAGS_OTHER}" "PC_${_component}_CFLAGS_OTHER")
  ...
  foreach (_component ${FFmpeg_FIND_COMPONENTS})
    ...
    if (${_component}_FOUND)
      ...
      if (NOT TARGET FFmpeg::${_lowerComponent})
        ...
        set(_ffmpeg_target_link_libraries)
        list(APPEND _ffmpeg_target_link_libraries ${${_component}_LIBRARIES} ${PC_${_component}_LIBRARIES})
        strip_whitespace_from_list(_ffmpeg_target_link_libraries)
        set_target_properties(FFmpeg::${_lowerComponent} PROPERTIES
            INTERFACE_COMPILE_OPTIONS "${${_component}_DEFINITIONS}"
            INTERFACE_INCLUDE_DIRECTORIES "${${_component}_INCLUDE_DIRS}"
            INTERFACE_LINK_LIBRARIES "${_ffmpeg_target_link_libraries}"
